...
import com.basheer.whatsappclone.databinding.ItemStatusBinding;
...
public class TopStatusAdapter extends RecyclerView.Adapter<TopStatusAdapter.TopStatusViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TopStatusViewHolder holder, int position) {
        ...
        // Create a SimpleDateFormat instance with time format
        ...
        holder.binding.statusCount.setPortionsCount(userStatus.getStatuses().size());

        holder.binding.statusCount.setOnClickListener(new View.OnClickListener() {
            @Override
